...
### Compression caveats
- **Level 1 only** — only the `fast` strategy is included to keep the binary small. Any `level` other than `1` throws. If you need maximum ratio you'll need a different library.
